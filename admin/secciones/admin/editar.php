...
if(isset($_GET['txtID'])){
    ...
    $sentencia = $conexion->prepare("SELECT * FROM tabla_admin WHERE ID=:ID");
...
if ($_POST){
    ...
    $sentencia = $conexion->prepare("UPDATE tabla_admin 
    SET usuario=:usuario, password=:password WHERE ID=:ID ");
